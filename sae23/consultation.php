...
function fetchLastSensorValues() {
    ...
    // Requête pour récupérer les dernières valeurs des capteurs de température pour les salles 
    $query = "
    ...
    if ($result) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            // Si capteur n'est pas dans tableau, ajout de sa valeur
...
// Récupération des dernières valeurs des capteurs
$last_values = fetchLastSensorValues();

// Affichage les résultats dans le HTML
?>
<nav>
