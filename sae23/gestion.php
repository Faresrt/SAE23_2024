...
function checkLogin($login, $mdp) {
    ...
    try {
        ...
        if (mysqli_num_rows($result) > 0) {
            // Vérification du nom du gestionnaire pour rediriger vers la bonne page
            if ($login == "UserRT" && $mdp == "passRT") {
                ...
                // Stocke le nom du nouvel utilisateur dans la session
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Appele la fonction pour vérifier les informations de connexion
